...
def calculate_reward(instruction_offset_1, instruction_offset_2):
    ...
    if instructions[index_1].accessed_offset == instructions[index_2].accessed_offset == "32800":
...
try:
    with open("states_binary_idiom1", "rb") as pickle_file:
...
with open("states_binary_idiom1", "wb") as pickle_file:
